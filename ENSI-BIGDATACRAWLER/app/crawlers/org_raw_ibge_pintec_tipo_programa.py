...
def __fix_column_names(df):
    name_conversion = {
        'EMPRESAS_QUE_IMPLEMENTARAM_INOVACOES_QUE_RECEBERAM_APOIO_DO_GOVERNO_POR_TIPO_DE_PROGRAMA_SUBVENCAO__ECONOMICA_LEI_DA_INFORMATICA_2':'EMPRESAS_QUE_IMPLEMENTARAM_INOVACOES_QUE_RECEBERAM_APOIO_DO_GOVERNO_POR_TIPO_DE_PROGRAMA_SUBVENCAO__ECONOMICA',
        'EMPRESAS_QUE_IMPLEMENTARAM_INOVACOES_QUE_RECEBERAM_APOIO_DO_GOVERNO_POR_TIPO_DE_PROGRAMA_FINANCIAMENTO_A_COMPRA_DE_MAQUINAS_E_EQUIPAMENTOS_UTILIZADOS_PARA_INOVAR_EM_PARCERIA_COM_UNIVERSIDADES':'EMPRESAS_QUE_IMPLEMENTARAM_INOVACOES_QUE_RECEBERAM_APOIO_DO_GOVERNO_POR_TIPO_DE_PROGRAMA_FINANCIAMENTO_A_COMPRA_DE_MAQUINAS_E_EQUIPAMENTOS_UTILIZADOS_PARA_INOVAR',
        'EMPRESAS_QUE_IMPLEMENTARAM_INOVACOES_QUE_RECEBERAM_APOIO_DO_GOVERNO_POR_TIPO_DE_PROGRAMA_OUTROS_PROGRAMAS_DE_APOIO_A_COMPRA_DE_MAQUINAS_E_EQUIPAMENTOS_UTILIZADOS_PARA_INOVAR_EM_PARCERIA_COM_UNIVERSIDADES':'EMPRESAS_QUE_IMPLEMENTARAM_INOVACOES_QUE_RECEBERAM_APOIO_DO_GOVERNO_POR_TIPO_DE_PROGRAMA_OUTROS_PROGRAMAS_DE_APOIO',
        'EMPRESAS_QUE_IMPLEMENTARAM_INOVACOES_QUE_RECEBERAM_APOIO_DO_GOVERNO_POR_TIPO_DE_PROGRAMA_COMPRAS_PUBLICAS_A_COMPRA_DE_MAQUINAS_E_EQUIPAMENTOS_UTILIZADOS_PARA_INOVAR_EM_PARCERIA_COM_UNIVERSIDADES':'EMPRESAS_QUE_IMPLEMENTARAM_INOVACOES_QUE_RECEBERAM_APOIO_DO_GOVERNO_POR_TIPO_DE_PROGRAMA_COMPRAS_PUBLICAS'
    }

    df.columns = [name_conversion[column] if column in name_conversion.keys() else column for column in df.columns]
...
def main(**kwargs):
    ...
    tmp = '/tmp/org_raw_pintec_tipo_programa/'
    table = 'pintec_tipo_programa'
