...
def main(**kwargs):
    ...
    key_name = 'org_raw_microdados_caged_ajustes'
    tmp = '/tmp/org_raw_microdados_caged_ajustes/'
    ...
    try:
        ...
        base_ftp_server = 'ftp://ftp.mtps.gov.br/pdet/microdados/CAGED_AJUSTES/'
